...
var $author$project$PhotoGroove$Photo = function (a) {
	return {$: 'Photo', a: a};
};
var $author$project$PhotoGroove$initialModel = {
	...
	photos: _List_fromArray(
		[
			$author$project$PhotoGroove$Photo('1.jpeg'),
			$author$project$PhotoGroove$Photo('2.jpeg'),
			$author$project$PhotoGroove$Photo('3.jpeg')
		]),
	selectedUrl: '1.jpeg'
};
