...
var $author$project$PhotoGroove$initialCmd = $elm$http$Http$get(
	{
		...
		url: $author$project$PhotoGroove$urlPrefix + '/photos/list.json'
	});
...
var $author$project$PhotoGroove$init = function (version) {
	var activity = 'Initializing Pasta v' + $elm$core$String$fromFloat(version);
...
var $author$project$PhotoGroove$applyFilters = function (model) {
	...
	switch (_v0.$) {
		case 'Loaded':
			...
			return _Utils_Tuple2(
				model,
				$author$project$PhotoGroove$setFilters(filterOptions));
		case 'Loading':
...
var $author$project$PhotoGroove$rangerSlider = $elm$html$Html$node('range-slider');
